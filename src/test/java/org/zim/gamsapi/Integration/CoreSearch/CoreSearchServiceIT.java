...
public class CoreSearchServiceIT extends CoreSearchIntegrationTest {
  ...
  public class IngestResult {
    ...
    @Test
    public void hasExpectedMappedEnglishDCCreator() {
      Assertions.assertThat(FOUND_ENTITY.getCreators())
          .isNotEmpty()
          .anySatisfy(dcElement -> {
            Assertions.assertThat(dcElement.getName()).isEqualTo("creator");
            Assertions.assertThat(dcElement.getValue()).isEqualTo("test-dc-creator-en");
            Assertions.assertThat(dcElement.getLang()).isEqualTo("en");
          });
    }
    ...
    @Test
    public void hasExpectedMappedEnglishDCContributor() {
      Assertions.assertThat(FOUND_ENTITY.getContributors())
          .isNotEmpty()
          .anySatisfy(dcElement -> {
            Assertions.assertThat(dcElement.getName()).isEqualTo("contributor");
            Assertions.assertThat(dcElement.getValue()).isEqualTo("test-dc-contributor-en");
            Assertions.assertThat(dcElement.getLang()).isEqualTo("en");
          });
    }

    @Test
    public void hasExpectedMappedEnglishDCLanguage() {
      Assertions.assertThat(FOUND_ENTITY.getLanguages())
          .isNotEmpty()
          .anySatisfy(dcElement -> {
            Assertions.assertThat(dcElement.getName()).isEqualTo("language");
            Assertions.assertThat(dcElement.getValue()).isEqualTo("test-dc-language-en");
            Assertions.assertThat(dcElement.getLang()).isEqualTo("en");
          });
    }
