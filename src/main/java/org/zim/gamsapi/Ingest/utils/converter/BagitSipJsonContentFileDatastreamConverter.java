...
@Slf4j
@Component
public class BagitSipJsonContentFileDatastreamConverter implements Converter<BagSipJsonContentFile, Datastream>{


  @Override
  public Datastream convert(BagSipJsonContentFile source) {
